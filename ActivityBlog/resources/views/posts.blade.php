...
<header id="main-header">
    ...
    <nav id="menu" class="navbar navbar-expand-lg navbar-light  justify-content-between ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="exit">
                    <a id="logOutI" class="nav-link " href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout').submit();">
