...
<body>
  ...
  <header id="main-header">
    ...
    <nav class="navbar navbar-expand-lg navbar-light  justify-content-between ">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav">
          <li class="nav-item ">
            <a class="nav-link" href="index"> <svg width="1em" height="1em" viewBox="0 0 16 16"
          ...
          <li class="nav-item">
            <a class="nav-link" href="creation"> <svg width="1em" height="1em" viewBox="0 0 16 16"
          ...
          <li class="nav-item">
            <a class="nav-link active" href="events"> <svg width="1em" height="1em" viewBox="0 0 16 16"
              ...
              </svg> Events <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="eshop"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-shop"
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4">
        <button  type="button"  data-toggle="tooltip" data-placement="top" title="Find my events" id="trackme"><i class="fas fa-street-view fa-10x"></i></button>
      </div>
      <div class="col-md-8">
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA_XutZaq6kFoCFVsGC1TCwWCHZmz1VLII" async
    defer></script>
