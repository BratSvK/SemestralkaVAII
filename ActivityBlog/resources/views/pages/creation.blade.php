...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"
    ...
    <script type="text/javascript" src="{{ URL::asset('js/creations.js') }}" defer></script>
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light  justify-content-between ">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="creation"> <svg width="1em" height="1em" viewBox="0 0 16 16"
              ...
              </svg>Creation <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    <div class="col text-center">
      <button type="button" id="addActivity" data-toggle="tooltip" data-placement="top" title="Create an activity">
