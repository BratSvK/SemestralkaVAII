...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/js/bootstrap.bundle.min.js"
        ...
        <script type="text/javascript" src="{{ URL::asset('js/eshop.js') }}" defer></script>
    ...
    <header id="main-header">
        ...
        <nav class="navbar navbar-expand-lg navbar-light  justify-content-between ">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav">
                    <li class="nav-item ">
                        <a class="nav-link" href="posts"> <svg width="1em" height="1em" viewBox="0 0 16 16"
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="events"> <svg width="1em" height="1em" viewBox="0 0 16 16"
                                class="bi bi-calendar-event-fill" fill="currentColor"
                    ...
                    <li class="nav-item">
                        <a class="nav-link active " href="eshop"> <svg width="1em" height="1em" viewBox="0 0 16 16"
                            ...
                            </svg> Shop <span class="sr-only">(current)</span></a>
                    </li>
                </ul>
                <div class="exit">
                    <a id="logOutI" class="nav-link " href="{{ route('logout') }}" >
