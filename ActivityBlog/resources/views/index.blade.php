    ...
    <nav class="navbar navbar-expand-lg navbar-light  justify-content-between ">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="tabs/creation.html"> <svg width="1em" height="1em" viewBox="0 0 16 16"
          ...
          <li class="nav-item">
            <a class="nav-link" href="tabs/events.html"> <svg width="1em" height="1em" viewBox="0 0 16 16"
          ...
          <li class="nav-item">
            <a class="nav-link " href="tabs/eshop.html"> <svg width="1em" height="1em" viewBox="0 0 16 16"
    ...
    <div class="row">
      <ul class="info rounded list-group col-md-2">
        ...
        <li class="list-group-item d-flex justify-content-between align-items-center">Main Goal: <span
            class="badge badge-primary badge-pill"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check"
      ...
      <div class="col-md-10">
        ...
        <section id="finished-projects">
          ...
          <ul>
            <li id="p3" data-extra-info="Super important party! Needed to be cool!" class="card" draggable="true">
              <h2> <span> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-exclamation-square text-danger"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                      d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                    <path
                      d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z" />
                  </svg></span> Book Table </h2>
              <p>
